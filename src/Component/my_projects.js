const my_projects = [
  {
    ...
    resume_description:
      "An activewear/accessories e-commerce site for men and women.",
    tools:
      "Angular | NgRx | HTML | CSS | Bootstrap | NodeJS | Express | MongoDB",
  ...
  },
  {
    ...
    tools:
      "Ruby on rails | ReactJS | Redux | Socket.io | HTML | CSS | Bootstrap",
    github: "https://github.com/vienpham2019/The_Movies",
    demo: "https://the-movies-f6ace.web.app/",
    video: false,
    image: "project_img/The_Movies.png",
  },
  {
  ...
  },
  {
    ...
    resume_description:
      "A serene setting where you can enjoy nature and relish luxury and comfort.",
    details: [
    ...
    tools:
      "NodeJS | Express | ReactJS | Redux | HTML | CSS | Bootstrap | MongoDB",
...

  {
    ...
    description:
      "League Tracker was designed to help users to track he/she or other League of Legends match history, ranked tier and view hundred champion’s info in game.",
    resume_description: "A great way to track your League of Legends account.",
    details: [
      "Built the frontend with React, and Ruby on Rails for backend with JSON token for authentication.",
      "Fetch League of Legends API from backend.",
      "Styled frontend with Bootstrap, CSS and Semantic UI React.",
    ],
  ...
  },
  {
    ...
    details: [
      "Created frontend and backend with Ruby on Rails application.",
      "Used CSS to design the frontend.",
    ],
